...
public class PostService {
    ...
    public PostResponseServiceDto getPostById(Long postId) {
        ...
        var content = postContent.getText();
        return new PostResponseServiceDto(targetPost, content);
    }
    ...
    public PostResponseServiceDto createPost(PostAddRequestServiceDto dto) {
        ...
        //create post index
        var plainText = markdownConvertor.convertToPlainText(newPostContent.getText(), false);
        var newPostIndex = newPost.toIndex(plainText);
        postIndexRepository.save(newPostIndex);

        return new PostResponseServiceDto(newPost, newPostContent.getText());
    }
    ...
    public PostResponseServiceDto uploadPost(PostUploadRequestServiceDto dto) {
        ...
        return new PostResponseServiceDto(resultPost, dto.getContent());
    }
    ...
    public Post updatePostWithFile(Series targetSeries, PostUploadRequestServiceDto dto, Post targetPost){
        ...
        //update post index
        var postIndex = savedPost.toIndex(markdownConvertor.convertToPlainText(updatedPostContent.getText(), false));
    ...
    public PostResponseServiceDto updatePost(PostUpdateRequestServiceDto dto) {
        ...
        //update post index
        var postIndex = updatedPost.toIndex(markdownConvertor.convertToPlainText(updatedPostContent.getText(), true));
        postIndexRepository.save(postIndex);

        return new PostResponseServiceDto(updatedPost, updatedPostContent.getText());
    }
